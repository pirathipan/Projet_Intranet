...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('IntranetBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('IntranetBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('IntranetBundle\Form\NoteType', $note);
